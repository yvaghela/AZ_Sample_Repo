...
(     
      select  masterpatientid,patientid,indexdate,gender,age from inclusion EXCEPT select  masterpatientid,patientid,indexdate,gender,age from IC_UNION)
...
------ Cerebrovascular disease 
	select count(distinct masterpatientid) from ( select * from clinical_disrection) clinical_disr
  ...
  INNER JOIN (select patientid, dxdate as com_date, SOURCEDXCODEDESCRIPTION	as Name from 
             ...
             on clinical_disr.patientid = Comorbidities.patientid
