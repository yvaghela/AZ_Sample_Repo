...
WITH  ST_or_HM as (
      select distinct masterpatientid,all_pat.patientid from 
 ...
 INNER JOIN (select patientid, encounterdate
  ...
  ---------any_malignancy_or_metastatic_solid_tumor           
   inner join (Select patientid, dxdate from (
                                                      SELECT dataownerid,patientid, dxdate
                                      ...
                                      ON all_pat.patientid = any_malignancy_or_metastatic_solid_tumor.patientid
...
ST_HM_TREAT as (
                select distinct masterpatientid, ST_or_HM.patientid from ST_or_HM
 inner join cancer_codes_treat
 on ST_or_HM.patientid = cancer_codes_treat.patientid
 where drug_date >= ((DATE('2022-02-24'))-365) AND drug_date < DATE('2022-02-24')
...
----------Solid Tumors/ Hematological Malignancies Not on Treatment      
  ...
  ST_or_HM2 as (select distinct masterpatientid, all_pat.patientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
...
ST_HM_NOT_TREAT as (
                        select distinct masterpatientid, ST_or_HM2.patientid from ST_or_HM2
...
------------------------------Corticosteroids----------------
 immuno_pat as (select distinct masterpatientid, all_pat.patientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
...
INNER JOIN (   Select patientid, medadminstartdate as dxdate
   ...
   corti_pat as (select distinct masterpatientid, all_pat.patientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
...
'c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
 ...
 INNER JOIN (select patientid, encounterdate
  ...
  UNION ALL 
     ...
     where drugdate >= ((DATE('2022-02-24')) - 30) and drugdate < DATE('2022-02-24') 
   ), 
   
    Corticosteroids as (
     select distinct MASTERPATIENTID, immuno_pat.patientid from immuno_pat
    UNION ALL
        select distinct MASTERPATIENTID, corti_pat.patientid from corti_pat
    ) ---select * from Corticosteroids
    ,
    
  ----------------------------------------HIV-----------------------------------  
     INCLUSION_PAT as (select distinct masterpatientid, all_pat.patientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
 ...
 INNER JOIN (select patientid, encounterdate
    ...
    AIDS as (
           (select * from(
             ...
             from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_LABRESULTS"
    ...
    HIV_AIDS as (
     select distinct masterpatientid, INCLUSION_PAT.patientid from INCLUSION_PAT
    inner join HIV
    on HIV.patientid = INCLUSION_PAT.patientid
    inner join AIDS
    on AIDS.patientid = HIV.patientid
    where (dxdate > ((DATE('2022-02-24')) - 365) AND dxdate < DATE('2022-02-24')) AND (RESULTDATE > ((DATE('2022-02-24')) - 365) AND RESULTDATE < DATE('2022-02-24')) 
    ) ---select * from HIV_AIDS
    ,
    ---Solid Organ or Islet----------------------
    ----Recipients of Solid Organ or Islet Transplant--------------------------------------------------------------------------------


 solid_organ_islet as ( select distinct masterpatientid, all_pat.patientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
                        ...
                        UNION ALL
                          ...
                          where dxcode in ('C80.2','I25.750','I25.751','I25.758','I25.759','I25.760','I25.761','I25.768','I25.769','I25.811',
                                          ...
                                          '429490004','737294004','429054002','13160009','30700006','33167004','44165003','58797008','313039003',
                                           ...
                                           '119906009','359641007','14970003','59654003','264581005','56908006') and dxdate is not null 
   
)) solid_organ_transplant
            
                                     on all_pat.patientid = solid_organ_transplant.patientid
                                     where dxdate < DATE('2022-02-24')
    ) ---select * from solid_organ_islet
    ,
       ----Moderate or severe immmumo-----------------------------------------------------
   
  mod_sev_immuno as (select distinct masterpatientid, all_pat.patientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
...
'c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
 ...
 INNER JOIN (select patientid, encounterdate
  ...
  inner join (select patientid, dxdate
             ...
             on all_pat.patientid = Primary_Immunodeficiency_Diagnoses.patientid
             where (dxdate >= ((DATE('2022-02-24')) - 365) AND dxdate < DATE('2022-02-24'))
    )
    --select * from mod_sev_immuno
    
    ,
    -----------------------------------------------------------CART Stem Cell Transplant----------------
    CART_HSCT as (select distinct masterpatientid, all_pat  
  .patientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
...
and DATEDIFF(year,BIRTHDATE,DATE('2022-02-24')) >= 12                                                                       ) a_pat
 ...
 INNER JOIN (select patientid, encounterdate
         ...
         ) CAR_T on all_pat.patientid = CAR_T.patientid
         where dxdate >= ((DATE('2022-02-24')) - 365) and dxdate < DATE('2022-02-24')
  ...
  inner join (Select patientid, dxdate from (
                        ...
                        UNION ALL
                          ...
                          where dxcode in ( 'Z52.001','Z52.011','Z52.091','Z94.84'
                                           ...
                                           on all_pat.patientid = HSCT.patientid
         where dxdate >= ((DATE('2022-02-24')) - 365) and dxdate < DATE('2022-02-24')  )
    ...
    ESRD as ( select distinct masterpatientid, all_pat.patientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
 ...
 INNER JOIN (select patientid, encounterdate
             ...
             inner join (Select patientid, dxdate from (
                                    ...
                                    UNION ALL
                                      SELECT patientid, dxdate
                                      FROM "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_DIAGNOSES"
                                      where dxcode in ('I12.0','I13.11','I13.2','N18.6') and dxdate is not null 
)) ESRD
                      ON all_pat.patientid = ESRD.patientid
                                   where (dxdate >= ((DATE('2022-02-24')) - 365) AND dxdate < DATE('2022-02-24'))
    ) ---select * from ESRD
    ,
    Total_Immuno AS(
    ...
    select distinct masterpatientid, patientid from ST_HM_TREAT
    UNION ALL
    select distinct masterpatientid, patientid from ST_HM_NOT_TREAT
    UNION ALL
    select distinct masterpatientid, patientid from Corticosteroids
    UNION ALL
    select distinct masterpatientid, patientid from HIV_AIDS
    UNION ALL
    select distinct masterpatientid, patientid from solid_organ_islet
    UNION ALL
    select distinct masterpatientid, patientid from CART_HSCT
    UNION ALL
    select distinct masterpatientid, patientid from mod_sev_immuno
    UNION ALL
    select distinct masterpatientid, patientid from ESRD
	)  --select * from Total_Immuno
    ,
    

--All Cause Hospitalization---------------------------------
ALL_CAUSE_HOSP AS(
select distinct masterpatientid from Total_Immuno
  inner join "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS"
  on Total_Immuno.patientid = "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS".patientid
  where ((encounterdate > (DATE('2022-02-24')) AND encounterdate <= ((DATE('2022-02-24'))+180) AND encounterdate is not null)
            AND ENCOUNTERTYPE IN ('EI', 'IP'))   ) --select * from ALL_CAUSE_HOSP
            ,
 
--Post Covid Condition---------------------------------
 
  encounter as (select patientid, encounterdate as dx_encounterdate, encountertype, encounterid
  from"DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS" where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11','5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b','6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3','86d8165865fdd068bbb2b235990d6ea56c39fac4a5dc1cc53f65d6bc675e6363','a3bc2a45e2fb93d0ea261db098c16e6d8156fcbca543157de8deffbb156c8901','c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
),
  
  long_covid as (select patientid, dxdate, pdx
                from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_DIAGNOSES"
                where dxcode IN ('U09','U09.9') and dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11','5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b','6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3','86d8165865fdd068bbb2b235990d6ea56c39fac4a5dc1cc53f65d6bc675e6363','a3bc2a45e2fb93d0ea261db098c16e6d8156fcbca543157de8deffbb156c8901','c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
 ),
 ...
 Post_Covid_Cond AS(
    ...
    on Total_Immuno.patientid = encounter.patientid
    inner join long_covid
    on long_covid.patientid = Total_Immuno.patientid
    where (dx_encounterdate > (DATE('2022-02-24')) AND dx_encounterdate <= ((DATE('2022-02-24'))+180) AND dx_encounterdate is not null))--select * from ALL_CAUSE_HOSP
	,
	
-------Medically Attended Covid----------------
 encounter1 as (select patientid, encounterdate, encountertype, encounterid
              from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS"
 where  dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11','5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b','6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3','86d8165865fdd068bbb2b235990d6ea56c39fac4a5dc1cc53f65d6bc675e6363','a3bc2a45e2fb93d0ea261db098c16e6d8156fcbca543157de8deffbb156c8901','c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')              
  ...
  select patientid , RESULTDATE AS dxdate,ENCOUNTERID, NULL as PDX
             from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_LABRESULTS"
                        where LABLOINC IN ('94562-6','94563-4','94564-2','94565-9','94639-2','94640-0','94641-8','94660-8','94756-4','94757-2',
                                ...
                                '94533-7','94534-5','94547-7','94558-4','94559-2') AND resultqual = 'ABNORMAL' and
 dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11','5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b','6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3','86d8165865fdd068bbb2b235990d6ea56c39fac4a5dc1cc53f65d6bc675e6363','a3bc2a45e2fb93d0ea261db098c16e6d8156fcbca543157de8deffbb156c8901','c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')) 
                             where PDX = 'P'), 
   ...
   combined_1  as(                         
            select distinct masterpatientid from Total_Immuno
            inner join encounter1
            on Total_Immuno.patientid = encounter1.patientid
            inner join covid1
            on covid1.encounterid = encounter1.encounterid
             where ((encounterdate > (DATE('2022-02-24')) AND encounterdate <= ((DATE('2022-02-24'))+180) AND encountertype is NOT NULL AND encounterdate is not null))),
             
 combined_2 as (select distinct masterpatientid from Total_Immuno
            inner join encounter1
            on Total_Immuno.patientid = encounter1.patientid
            inner join covid1
            on covid1.encounterid = encounter1.encounterid
             where ((encounterdate > ((DATE('2022-02-24'))+6) AND encounterdate <= ((DATE('2022-02-24'))+180) AND encountertype is not null AND encounterdate is not null
                    AND dxdate >= (encounterdate - 14) AND dxdate <= encounterdate))),
					
	Med_Attended_Covid AS(				
                    
          select * from combined_1
          UNION ALL
          select * from combined_2) --Select * from Med_Attended_Covid
		  ,
...
All_Cause_Mort AS(
  select distinct Total_Immuno.masterpatientid from Total_Immuno
  inner join "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS" encounter
  on encounter.patientid = Total_Immuno.patientid
  inner join "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" patients
  on patients.patientid = Total_Immuno.patientid
  where (encounterdate > (DATE('2022-02-24')) AND encounterdate <= ((DATE('2022-02-24'))+180) AND encounterdate is not null)
  AND DECEASEDDATE is not NULL) --Select * from All_Cause_Mort
  ,
...
---------------------------------------SARS COV2 Infection------------------------------------------------------------
     ...
     encounter2 as (select patientid, encounterdate, encounterid, encountertype
                  from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS" where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11','5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b','6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3','86d8165865fdd068bbb2b235990d6ea56c39fac4a5dc1cc53f65d6bc675e6363','a3bc2a45e2fb93d0ea261db098c16e6d8156fcbca543157de8deffbb156c8901','c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
),
     ...
     covid_diagnosis as (
       select patientid, dxdate,ENCOUNTERID, PDX, NULL as resultqual
             from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_DIAGNOSES"
                          where dxcode IN ('U07.1','J12.82','441590008','674814021000119000') and dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11','5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b','6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3','86d8165865fdd068bbb2b235990d6ea56c39fac4a5dc1cc53f65d6bc675e6363','a3bc2a45e2fb93d0ea261db098c16e6d8156fcbca543157de8deffbb156c8901','c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
  ...
  select patientid , RESULTDATE AS dxdate,ENCOUNTERID, NULL as PDX, resultqual
             from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_LABRESULTS"
                        where LABLOINC IN ('94562-6','94563-4','94564-2','94565-9','94639-2','94640-0','94641-8','94660-8','94756-4','94757-2',
                                ...
                                '96986-5','97097-0','97098-8','98069-8','98131-6','98132-4','98493-0','98494-8','99596-9','99597-7',
                                '99772-6','94762-2','94307-6','94308-4','94309-2','94314-2','94316-7','94500-6','94507-1','94508-9',
                                '94533-7','94534-5','94547-7','94558-4','94559-2') AND resultqual = 'ABNORMAL' and dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11','5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b','6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3','86d8165865fdd068bbb2b235990d6ea56c39fac4a5dc1cc53f65d6bc675e6363','a3bc2a45e2fb93d0ea261db098c16e6d8156fcbca543157de8deffbb156c8901','c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
),

                                
SARS_COV2 AS(                                
      select distinct masterpatientid from Total_Immuno
      inner join encounter2
      on encounter2.patientid = Total_Immuno.patientid
      inner join covid_diagnosis
      on covid_diagnosis.patientid = Total_Immuno.patientid
      where encounterdate > ((DATE('2022-02-24'))+6) AND encounterdate <= ((DATE('2022-02-24'))+180) AND encounterdate is not null) --select * from  SARS_COV2   
,
...
Med_acute_care_cov AS(
select distinct masterpatientid from (
select masterpatientid,encounterdate from (
select EVU_EN_JOIN.* from (
select EVU_PAT.masterpatientid,EVU_PAT.patientid, DATE('2022-02-24') as indexdate,  encounterid, EVU_PAT.encounterdate from (
select masterpatientid,Total_Immuno.patientid,encounterdate from Total_Immuno inner JOIN "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS" en 
on en.patientid=Total_Immuno.patientid 
where encounterdate >= ((DATE('2022-02-24'))-365) AND encounterdate < DATE('2022-02-24') AND encounterdate is not null
              )EVU_PAT   
   inner join (select * from(
              ...
              where ((EN_PAT.encounterdate > (DATE('2022-02-24')) AND EN_PAT.encounterdate <= ((DATE('2022-02-24'))+180) AND EN_PAT.encounterdate is not null)
...
case
  ...
  END as enddate
from (
select EVU_PAT.masterpatientid,EVU_PAT.patientid, DATE('2022-02-24') as indexdate,  encounterid, EVU_PAT.encounterdate,dischargedate from (
select masterpatientid,Total_Immuno.patientid,encounterdate from Total_Immuno inner JOIN "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS" en 
on en.patientid=Total_Immuno.patientid 
where encounterdate >= ((DATE('2022-02-24'))-365) AND encounterdate < DATE('2022-02-24') AND encounterdate is not null
              )EVU_PAT   
...
---- Didn't use Z86.16 & U09.9 as mentioned in valueset file
  ...
  select patientid , RESULTDATE AS dxdate,ENCOUNTERID, NULL as PDX, resultqual
             from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_LABRESULTS"
                     ...
                     where dxdate >= (EVU_EN_JOIN.encounterdate - 14) AND dxdate <= enddate
                     
                     )COVID_HOSP1
                     
                     ) FINAL_COHORT) select * from Med_acute_care_cov
...
select EVU_PAT.masterpatientid,EVU_PAT.patientid, DATE('2022-02-24') as indexdate,  evu_encounterid, EVU_PAT.encounterdate from (
select masterpatientid,Total_Immuno.patientid,encounterdate from Total_Immuno inner JOIN "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS" en 
on en.patientid=Total_Immuno.patientid 
where encounterdate >= ((DATE('2022-02-24'))-365) AND encounterdate < DATE('2022-02-24') AND encounterdate is not null
              )EVU_PAT   
...
case
  ...
  END as enddate
from (
select EVU_PAT.masterpatientid,EVU_PAT.patientid, DATE('2022-02-24') as indexdate,  evu_encounterid, EVU_PAT.encounterdate,dischargedate from (
select masterpatientid,Total_Immuno.patientid,encounterdate from Total_Immuno inner JOIN "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS" en 
on en.patientid=Total_Immuno.patientid 
where encounterdate >= ((DATE('2022-02-24'))-365) AND encounterdate < DATE('2022-02-24') AND encounterdate is not null
              )EVU_PAT   
