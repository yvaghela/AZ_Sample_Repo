...
'c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
  and DATEDIFF(year,BIRTHDATE,DATE('2022-02-24')) >= 12  and  DATAREFRESHID=1                                                                    ) a_pat

 INNER JOIN (select patientid, encounterdate
             from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_ENCOUNTERS"
             where DATAREFRESHID=1
                          ) en
  ...
  ---------any_malignancy_or_metastatic_solid_tumor           
   inner join (Select patientid,DXDATE from (
                                                      ...
                                                      where dxcode in ('C00.0','C00.1','C70','C70.1','C70.9','C71.0','C71','C71.1','C71.2','C71.3',
                                                          ...
                                                          and dxdate is not null and DATAREFRESHID=1
                                          UNION ALL
                                                      SELECT dataownerid,patientid, dxdate
                                                      FROM "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_DIAGNOSES"
...
OR lower(SOURCEMEDADMINMEDNAME) like	lower('%VORINOSTAT%')
                                                    ...
                                                    and medadminstartdate is not null and DATAREFRESHID=1
)
                                                union all
...
OR lower(SOURCERXMEDNAME) like	lower('%VORINOSTAT%')
                                                    ...
                                                    and orderdate is not null and DATAREFRESHID=1
)
                                                union all
...
OR lower(SOURCEDRUGNAME) like	lower('%VORINOSTAT%')
                                                    ...
                                                    and filleddate is not null and DATAREFRESHID=1
))),
...
ST_HM_NOT_TREAT as (
                        select distinct masterpatientid from ST_or_HM2
...
------------------------------Corticosteroids----------------
with  immuno_pat as (select distinct masterpatientid, all_pat.patientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
...
INNER JOIN ( Select patientid, medadminstartdate as dxdate
                        ...
                        where SOURCEMEDADMINMEDNAME ILIKE ANY ('%alemtuzumab%','%belimumab%','%IBRUTINIB%','%ofatumumab%','%rituximab%',
                                                                      ...
                                                                      '%voclosporin%') and DATAREFRESHID = 1
   ...
   corti_pat as (select distinct masterpatientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
...
'c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
 ...
 INNER JOIN (select patientid, encounterdate
    ...
    INNER JOIN (
                 select patientid,drugdate from (select patientid, 
                                        ((DOSE*RXQUANTITY)/rxsupply_updated) as daily_dose,SOURCERXMEDNAME,drugdate from (
                  select patientid,SourceRxMedName,ORDERDATE as drugdate,REGEXP_SUBSTR(RXDOSEORDERED,'[0-9]*')  as DOSE,
                                          RXQUANTITY,RXENDDATE,RXSTARTDATE,
                  case 
                ...
                AND DOSE is NOT NULL AND  RXQUANTITY is NOT NULL and DATAREFRESHID = 1 AND REGEXP_SUBSTR(RXDOSEORDERED,'[0-9]*')!='' ) )
  ...
  UNION ALL 
              ...
              (select patientid,drugdate from (select patientid, ((DOSE*FILLEDQUANTITY)/DAYSSUPPLY) as daily_dose,SourceDrugName, drugdate from (
                  select patientid,SourceDrugName,FILLEDDATE as drugdate,REGEXP_SUBSTR(DOSAGE,'[0-9]*') as DOSE, DAYSSUPPLY,FILLEDQUANTITY
                 from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_MEDFILLS"
                ...
                AND DOSE is NOT NULL AND  FILLEDQUANTITY is NOT NULL  and DATAREFRESHID = 1 AND REGEXP_SUBSTR(DOSAGE,'[0-9]*')!='' ) )
    ...
    ) select DISTINCT masterpatientid from Corticosteroids
    
    
  ----------------------------------------HIV-----------------------------------  
    with INCLUSION_PAT as (select distinct masterpatientid, all_pat.patientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
...
'c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
 ...
 INNER JOIN (select patientid, encounterdate
    ...
    (select * from (select patientid, dxdate          
               from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_DIAGNOSES"
               where dxcode IN ('B20','B97.35','O98.7','O98.71','O98.711','O98.712','O98.713','O98.719','O98.72','O98.73','Z21') and DATAREFRESHID = 1
    ...
    AIDS as (
           (select * from(
             ...
             AND SOURCELABNAME  NOT like '%/%' AND lower(SOURCELABNAME)  NOT like '%ratio%' AND lower(SOURCELABNAME)  NOT like '%cd45%' 
               ...
               AND lower(resultunit) not like '%fl%' AND lower(resultunit) not like '%pg%' AND lower(resultunit) not like '%dl%' and DATAREFRESHID = 1
    ...
    HIV_AIDS as (
     select distinct masterpatientid from INCLUSION_PAT
    inner join HIV
    ...
    ) select distinct masterpatientid from HIV_AIDS
    ,
    ---Solid Organ or Islet----------------------
    ----Recipients of Solid Organ or Islet Transplant--------------------------------------------------------------------------------


 solid_organ_islet as (select distinct masterpatientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
...
'c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
 ...
 INNER JOIN (select patientid, encounterdate
  ...
  inner join (select patientid, dxdate
    ...
    CART_HSCT as (select distinct masterpatientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
...
'c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
 ...
 INNER JOIN (select patientid, encounterdate
  ...
  inner join (Select patientid, dxdate from (
    ...
    ESRD as ( select distinct masterpatientid from 
                           (  select masterpatientid,a_pat.patientid,a_pat.dataownerid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
...
'c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
 ...
 INNER JOIN (select patientid, encounterdate
    ...
    select distinct masterpatientid from ST_HM_TREAT
    UNION ALL
    select distinct masterpatientid from ST_HM_NOT_TREAT
    UNION ALL
    select distinct masterpatientid from Corticosteroids
    UNION ALL
    select distinct masterpatientid from HIV_AIDS
    UNION ALL
    select distinct masterpatientid from solid_organ_islet
    UNION ALL
    select distinct masterpatientid from CART_HSCT
    UNION ALL
    select distinct masterpatientid from mod_sev_immuno
    UNION ALL
    select distinct masterpatientid from ESRD
