...
select distinct masterpatientid, age_group,Condition_Name from (
------Diabetes with chronic complications

select distinct masterpatientid,all_pat.patientid, age_group,'Diabetes_with_chronic_complications' AS Condition_Name from(
...
select distinct masterpatientid,all_pat.patientid, age_group,'Diabetes_without_chronic_complications' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'CKD' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'CHF' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Chronic_pulmonary_disease' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Mild_liver_disease' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Moderate_or_severe_liver_disease' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Dementia' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Myocardial_infarction' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Peripheral_vascular_disease' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Cerebrovascular_disease' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Hemiplegia_or_paraplegia' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Rheumatologic_disease' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Peptic_ulcer_disease' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Any_malignancy_including_leukemia_and_lymphoma' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'Metastatic_solid_tumor' AS Condition_Name from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select distinct masterpatientid,all_pat.patientid, age_group,'AIDS_HIV' from(
select masterpatientid,patientid,'0-49' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where datediff(days,date(birthdate),'2022-02-24')<50 
UNION ALL
select masterpatientid,patientid,'50-59' as age_group from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
select count(distinct masterpatientid), age_group from (
------Diabetes with chronic complications
