## Total distinct patients in control cohort 

select distinct masterpatientid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
...
## distinct Evusheld exposed patients 
...
OR lower(sourcemedadminmedname) like '%tixagevimab%' OR lower(sourcemedadminmedname) like'%cilgavimab%' 
UNION ALL
...
where (lower(SOURCERXMEDNAME) like '%tixagevimab%' OR lower(SOURCERXMEDNAME) like '%cilgavimab%')
UNION ALL
...
OR lower(SOURCEDRUGNAME) like '%tixagevimab%' OR lower(SOURCEDRUGNAME) like '%cilgavimab%'
) where medadminstartdate IS NOT NULL


## Gender

select distinct patientid from 
(select patientid, gender from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS")
      where gender = 'OT'
...
## age 
 ...
 select distinct masterpatientid from (select masterpatientid, patientid,dataownerid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS" 
where dataownerid IN('137301f961d1fd77b33c529c9be609e52c35aca429583fc49b93ffb36487101a','1cbb8cafcbcfc22addedb1d9e2034afe0a29bb5b74f1f230dfd58e12322a3e11',
'5540c5b22e7435d6eb2a63e3a80b623d75eb34812013cb78575843f661f9bbc7','5fdd0ff9ae31f6c7ce6a195bd1a13b382143b8b6e70780fc18acf579dfc5e54b',
'6b952660a48d81f2da56f80a7a695446ea01ba3942c0ee6da3f38dafb5d60920','7804f6717b418811a9797e1805a921fb5b9582943c78e3924925d551c650a2a3',
'86d8165865fdd068bbb2b235990d6ea56c39fac4a5dc1cc53f65d6bc675e6363','a3bc2a45e2fb93d0ea261db098c16e6d8156fcbca543157de8deffbb156c8901',
...
'c48925c0b23c35d71a975a18c9478d371ad8c12b94b3e179bd1db880d48e56df','c877ef723bbc0de29171dcaa993fe3b86064bb0d0d7be4523bb0b71688ebbb72')
 ...
 select distinct "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS".masterpatientid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS"
inner join (
           (Select patientid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_DIAGNOSES"
  ...
  ------Advanced or untreated human immunodeficiency virus (HIV) infection
              OR dxcode IN ('B20','B97.35','O98.7','O98.71','O98.711','O98.712','O98.713','O98.719','O98.72','O98.73','Z21')
  ...
  UNION ALL
          ...
          ( select patientid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PROCEDURES"
  ...
  UNION ALL
            (select patientid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_LABRESULTS"
            where LABLOINC = '65758-5')
  
  UNION ALL 
  
           (select patientid from "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_MEDADMINS"
...
OR lower(SOURCEMEDADMINMEDNAME) like	lower('%VORINOSTAT%') )
  ...
  ) a on "DEID_PLATFORM"."GRATICULESOW3A"."VW_DEID_PATIENTS".patientid = a.patientid
 ...
 select distinct masterpatientid from (select masterpatientid, all_pat.patientid, cast(datediff(year,birthdate,'2022-02-24')as to_date)  as Age
 ...
 INNER JOIN (select patientid, encounterdate
             ...
             on all_pat.patientid = en.patientid
             where (encounterdate >= (('2022-02-24')-365) AND encounterdate < '2022-02-24' AND encounterdate is not null)
             ) where age >= 12
